      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-12">
          <div class="tracking_box_inner">
            ...
            <form  action="/order/tracking/search" method="get" novalidate="novalidate">
              <div class="col-md-12 form-group">
                <input type="text" class="form-control" id="order" name="id" placeholder="Order ID">
              </div>
              <div class="col-md-12 form-group">
                <button type="submit"  class="btn_3">Track Order</button>
              </div>
            </form>
          </div>
        </div>
