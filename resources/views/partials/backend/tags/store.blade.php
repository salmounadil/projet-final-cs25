<section class="contact-section padding_top bannerback">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12">
          <h2 class="contact-title">New Tag</h2>
        </div>
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="/tag" method="POST" id="contactForm"
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <input class="form-control bg-white" name="nom" id="nom" type="text" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Enter your name'" placeholder='Tag Name' value="{{ old('nom') ? old('nom') : null }}">
                </div>
              </div>
